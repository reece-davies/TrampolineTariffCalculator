package com.intercry.trampolinetariffcalculator;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Declare Spinner and apply the adapter to the spinner.
    ...
    Calls  changeScreenValues() <item>Back in - full out</item>
    */
